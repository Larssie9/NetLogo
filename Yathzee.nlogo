...
to setup
  set selected-list list (1) (2)
  clear-all
  create-turtles 5
  ask turtles [set shape "die 6"]
  ask turtles [set color white]
  ask turtles [set size 10]
  ask turtle 0 [setxy 20 5]
  ask turtle 1 [setxy 0 5]
  ask turtle 2 [setxy -20 5]
  ask turtle 3 [setxy 7.5 -5]
  ask turtle 4 [setxy -7.5 -5]
  reset-ticks
end
...
to go
  ...
  if turtlenumber + 1 != selected-list  [
      if randomnumber = 1 [
